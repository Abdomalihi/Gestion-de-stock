...
<body class="modal-open">
            ...
            <div class="col-md-10 " style="padding: 10px; margin-top: 20px;height: calc(100vh - 160px)">
              <div class="container-fluid " style="height: 100%" >
                  ...
                  <div class="row bg-light" style="padding: 10px 30px 0px 30px">
                    <div class="col-md-12">
                        <p class="text-left" style="text-align:justify"><h3 style="margin: 10px"> Modifier Client</h3>  </p>
                    </div>
                  </div>
                  <div class="row bg-light" >
                    <div class="container">
                        <div>
							<form action="client-update.html" method="POST" >
								<div class="container-fluid">
								<input type="hidden" value='${ param["idclient"] }' name="idclient">
							  <div class="form-group">
				                  <label for="formGroupExampleInput">Nom :</label>
				                  <input type="text" class="form-control" id="formGroupExampleInput" placeholder="nom" name="nomclt" value="${client.nomclt }">
				                </div>
				                <div class="form-group">
				                  <label for="formGroupExampleInput2">Prénom :</label>
				                  <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="prénom" name="prenomclt" value="${client.prenomclt }">
				                </div>
				                <div class="form-group">
				                    <label for="formGroupExampleInput">Adresse :</label>
				                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="adresse" name="adresseclt" value="${client.adresseclt }">
				                </div>
				                <div class="form-group">
				                    <label for="formGroupExampleInput2">Email :</label>
				                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="exemple@exemple.com" name="emailclt" value="${client.emailclt }">
				                </div>
				                <div class="form-group">
				                      <label for="formGroupExampleInput2">Télphone :</label>
				                      <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="+212xxxxxxxxx" name="telclt" value="${client.telclt }">
				                </div>
				                <div class="form-group">
  ...
  <%-- <!-- Modal -->
  <div class="modal fade show" id="ajouter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-model="true" style="display: block" >
  <form action="update.html" method="post">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel" style="text-align: center">Modifier Client </h5>
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="formGroupExampleInput">Nom :</label>
                  <input type="text" class="form-control" id="formGroupExampleInput" placeholder="nom" value="${client.nomclt }">
                </div>
                <div class="form-group">
                  <label for="formGroupExampleInput2">Prénom :</label>
                  <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="prénom" value="${client.prenomclt }">
                </div>
                <div class="form-group">
                    <label for="formGroupExampleInput">Adresse :</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="adresse" value="${client.adresseclt }">
                </div>
                <div class="form-group">
                    <label for="formGroupExampleInput2">Email :</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="exemple@exemple.com" value="${client.emailclt }">
                </div>
                <div class="form-group">
                      <label for="formGroupExampleInput2">Télphone :</label>
                      <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="+212xxxxxxxxx" value="${client.telclt }">
                </div>
  ...
  <%-- <div class="modal fade show" id="ajouter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-model="true">
  <form action="update.html" method="post">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel" style="text-align: center">Ajouter Client </h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
