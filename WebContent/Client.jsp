...
<body>
          ...
          <div class="row FULL">
            <div class="col-md-2 Menuu"  style="padding-left: 3px; background-color: #1a1a00">
                <ul class="nav flex-column float-left" style="margin: 20px">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#" style="color:whitesmoke"><i class="fas fa-user-friends glyphicon-align-left"></i> Client</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-10 " style="padding: 10px; margin-top: 20px;height: calc(100vh - 160px)">
              <div class="container-fluid " style="height: 100%" >
                  ...
                  <div class="row bg-light" style="padding: 10px 30px 0px 30px">
                    <div class="col-md-12">
                        <p class="text-left" style="text-align:justify"><h3 style="margin: 10px">Client</h3>  </p>
                    </div>
                      <div class="col-md-6">
                          <ul class="nav ">
                              <li class="nav-item">
                      ...
                      <div class="col-md-6">
                          <form class="form-inline my-2 my-lg-0 float-right" action="client-chercher.html" method="get">
	                                  ...
	                                  <tr>
	                                    ...
	                                    <td>
	                                    	<div class="dropdown">
												  ...
												  <div class="dropdown-menu">
												    <a class="dropdown-item" href="client-modifier.html?idclient=${c.idclient}">Modifier</a>
												    <a class="dropdown-item" href="client-supprimer.html?idclient=${c.idclient}">Supprimer</a>
												  </div>
											</div>
										</td>
	                                  </tr>                                  	
  ...
  <form action="client-ajouter.html" method="post">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="formGroupExampleInput" name="nomclt" placeholder="nom">
                </div>
                <div class="form-group">
                  <label for="formGroupExampleInput2">Prénom :</label>
                  <input type="text" class="form-control" id="formGroupExampleInput2" name="prenomclt" placeholder="prénom">
                </div>
                <div class="form-group">
                    <label for="formGroupExampleInput">Adresse :</label>
                    <input type="text" class="form-control" id="formGroupExampleInput" name="adresseclt" placeholder="adresse">
                </div>
                <div class="form-group">
                    <label for="formGroupExampleInput2">Email :</label>
                    <input type="text" class="form-control" id="formGroupExampleInput2" name="emailclt" placeholder="exemple@exemple.com">
                </div>
                <div class="form-group">
                      <label for="formGroupExampleInput2">Télphone :</label>
                      <input type="text" class="form-control" id="formGroupExampleInput2" name="telclt" placeholder="+212xxxxxxxxx">
                </div>
