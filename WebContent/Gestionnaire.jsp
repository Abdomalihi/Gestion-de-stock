...
<body>
            ...
            <div class="col-md-10 " style="padding: 10px; margin-top: 20px;height: calc(100vh - 160px)">
              <div class="container-fluid " style="height: 100%" >
                  ...
                  <div class="row bg-light" style="padding: 10px 30px 0px 30px">
                    <div class="col-md-12">
                        <p class="text-left" style="text-align:justify"><h3 style="margin: 10px">Gestionnaire</h3>  </p>
                    </div>
                      <div class="col-md-6">
                          <ul class="nav ">
                              <li class="nav-item">
                      ...
                      <div class="col-md-6">
                          <form class="form-inline my-2 my-lg-0 float-right" action="gestionnaire-chercher.html" method="get">
                    ...
                    <div class="container">
                        <div class="table " >
                            <table class="table table-striped" style="padding-left: 5px">
                                  ...
                                  <c:forEach items="${model.gestionnaires}" var="g">
	                                  <tr>
	                                    <td scope="row">${g.iduser}</td>
	                                    <td>${g.login}</td>
	                                    <td>${g.password}</td>
	                                    <td>${g.nomuser}</td>
	                                    <td>${g.prenomuser}</td>
	                                    ...
	                                    <td>
	                                    	<div class="dropdown">
												  ...
												  <div class="dropdown-menu">
												    <a class="dropdown-item" href="gestionnaire-modifier.html?iduser=${g.iduser}">Modifier</a>
												    <a class="dropdown-item" href="gestionnaire-supprimer.html?iduser=${g.iduser}">Supprimer</a>
												  </div>
											</div>
										</td>
	                                  </tr>                                  	
  ...
  <form action="gestionnaire-ajouter.html" method="post">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel" style="text-align: center">Ajouter Gestionnaire </h5>
        ...
        <div class="modal-body">
            	<div class="form-row">
					    <div class="form-group col-md-6">
					      ...
					      <input type="email" class="form-control" id="inputEmail4" name="login" placeholder="login">
					    </div>
					    <div class="form-group col-md-6">
				...
				<div class="form-row">
					    <div class="form-group col-md-6">
					      ...
					      <input type="email" class="form-control" id="inputEmail4" name="nomuser" placeholder="nom">
					    </div>
					    <div class="form-group col-md-6">
					      <label for="inputPassword4">Prénom :</label>
					      <input type="password" class="form-control" id="inputPassword4" name="prenomuser" placeholder="prenom">
					    </div>
				</div>
				<div class="form-group">
					    <label for="inputAddress">Email :</label>
					    <input type="text" class="form-control" id="inputAddress" name="emailuser" placeholder="exemple@exemple.com">
  				</div>
				<div class="form-row">
					    <div class="form-group col-md-6">
					      <label for="inputEmail4">Télephone :</label>
					      <input type="email" class="form-control" id="inputEmail4" name="teluser" placeholder="+212xxxxxxxx">
					    </div>
					    <div class="form-group col-md-6">
					      <label for="inputPassword4">Type :</label>
					      <input type="password" class="form-control" id="inputPassword4" name="typeuser" placeholder="type">
					    </div>
				</div>
		</div>
