            ...
            <div class="col-md-10 " style="padding: 10px; margin-top: 20px;height: calc(100vh - 160px)">
              <div class="container-fluid " style="height: 100%" >
                  ...
                  <div class="row bg-light" style="padding: 10px 30px 0px 30px">
                    <div class="col-md-12">
                        <p class="text-left" style="text-align:justify"><h3 style="margin: 10px">Liste des Commandes</h3>  </p>
                    </div>
                      <div class="col-md-6">
                          <ul class="nav ">
                              <li class="nav-item">
                      ...
                      <div class="col-md-6">
                          <form class="form-inline my-2 my-lg-0 float-right" action="chercherCommande.html" method="get">
	                                  ...
	                                  <tr>
	                                    ...
	                                    <td>
	                                    	<div class="dropdown">
												  ...
												  <div class="dropdown-menu">
												    <a class="dropdown-item" href="detailCommande.html?idcmd=${c.idcmd}">Détails</a>
												    <a class="dropdown-item" href="modifierCommande.html?idcmd=${c.idcmd}">Modifier</a>
												    <a class="dropdown-item" href="supprimerCommande.html?idcmd=${c.idcmd}">Supprimer</a>
												  </div>
											</div>
										</td>
	                                  </tr>                                  	
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel" style="text-align: center">Ajouter Commande </h5>
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="formGroupExampleInput">Libelle Commande :</label>
