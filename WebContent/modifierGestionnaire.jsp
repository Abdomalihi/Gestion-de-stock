            ...
            <div class="col-md-10 " style="padding: 10px; margin-top: 20px;height: calc(100vh - 160px)">
              <div class="container-fluid " style="height: 100%" >
                  ...
                  <div class="row bg-light" style="padding: 10px 30px 0px 30px">
                    <div class="col-md-12">
                        <p class="text-left" style="text-align:justify"><h3 style="margin: 10px"> Modifier Gestionnaire</h3>  </p>
                    </div>
                  </div>
                  <div class="row bg-light" >
                    <div class="container">
                        <div>
							<form action="gestionnaire-update.html" method="POST" >
								
								<input type="hidden" value='${ param["iduser"] }' name="iduser">
					            	<div class="form-row">
										    <div class="form-group col-md-6">
										      <label for="inputEmail4">Login :</label>
										      <input type="email" class="form-control" id="inputEmail4" name="login" placeholder="login" value="${gestionnaire.login }">
										    </div>
										    <div class="form-group col-md-6">
										      <label for="inputPassword4">Password :</label>
										      <input type="password" class="form-control" id="inputPassword4" name="password" placeholder="password" value="${gestionnaire.password }">
										    </div>
									</div>
									<div class="form-row">
										    <div class="form-group col-md-6">
										      <label for="inputEmail4">Nom :</label>
										      <input type="email" class="form-control" id="inputEmail4" name="nomuser" placeholder="nom" value="${gestionnaire.nomuser }">
										    </div>
										    <div class="form-group col-md-6">
										      <label for="inputPassword4">Prénom :</label>
										      <input type="password" class="form-control" id="inputPassword4" name="prenomuser" placeholder="prenom" value="${gestionnaire.prenomuser }">
										    </div>
									</div>
									<div class="form-group">
										    <label for="inputAddress">Email :</label>
										    <input type="text" class="form-control" id="inputAddress" name="emailuser" placeholder="exemple@exemple.com" value="${gestionnaire.emailuser }">
					  				</div>
									<div class="form-row">
										    <div class="form-group col-md-6">
										      <label for="inputEmail4">Télephone :</label>
										      <input type="email" class="form-control" id="inputEmail4" name="teluser" placeholder="+212xxxxxxxx" value="${gestionnaire.teluser }">
										    </div>
										    <div class="form-group col-md-6">
										      <label for="inputPassword4">Type :</label>
										      <input type="password" class="form-control" id="inputPassword4" name="typeuser" placeholder="type" value="${gestionnaire.typeuser }">
										    </div>
									</div>
