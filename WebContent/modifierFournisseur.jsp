          ...
          <div class="row FULL">
            <div class="col-md-2 Menuu"  style="padding-left: 3px; background-color: #1a1a00">
                <ul class="nav flex-column float-left" style="margin: 20px">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="/FournisseurServlet/index.html" style="color:whitesmoke"><i class="fas fa-truck-loading glyphicon-align-left"></i> Fournisseur</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-10 " style="padding: 10px; margin-top: 20px;height: calc(100vh - 160px)">
              <div class="container-fluid " style="height: 100%" >
                  ...
                  <div class="row bg-light" style="padding: 10px 30px 0px 30px">
                    <div class="col-md-12">
                        <p class="text-left" style="text-align:justify"><h3 style="margin: 10px"> Modifier Fournisseur</h3>  </p>
                    </div>
                  </div>
                    ...
                    <div class="container">
                        <div>
							<form action="update.html" method="POST" >
								<div class="container-fluid">
								<input type="hidden" value='${ param["idfour"] }' name="idfour">
							  <div class="form-group">
				                  <label for="formGroupExampleInput">Nom :</label>
				                  <input type="text" class="form-control" id="formGroupExampleInput" placeholder="nom" name="nomfour" value="${fournisseur.nomfour }">
				                </div>
				                <div class="form-group">
				                  <label for="formGroupExampleInput2">Prénom :</label>
				                  <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="prénom" name="prenomfour" value="${fournisseur.prenomfour }">
				                </div>
				                <div class="form-group">
				                    <label for="formGroupExampleInput">Adresse :</label>
				                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="adresse" name="adressefour" value="${fournisseur.adressefour }">
				                </div>
				                <div class="form-group">
				                    <label for="formGroupExampleInput2">Email :</label>
				                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="exemple@exemple.com" name="emailfour" value="${fournisseur.emailfour }">
				                </div>
				                <div class="form-group">
				                      <label for="formGroupExampleInput2">Télephone :</label>
				                      <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="+212xxxxxxxxx" name="telfour" value="${fournisseur.telfour }">
				                </div>
				                <div class="form-group">
